...
(function() {
  module.exports = function(grunt) {
    var bower, bowerCss, bowerImg, bowerJs, css2Min, css2MinSync, css2Mult, css2MultSync, destCss, destCssMin, destCssMult, destFonts, destHtml, destImg, destJs, destJsMin, destJsMult, destJsRjs, dirs, js2Min, js2MinSync, js2Mult, js2MultSync, jsRequire, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, srcFonts, srcHtml, srcImg, srcImgMin;
    ...
    ref1 = [destCss + '/css2MinSync', destCss + '/css2MultSync', destJs + '/js2MinSync', destJs + '/js2MultSync', destJs + '/jsrequire'], destCssMin = ref1[0], destCssMult = ref1[1], destJsMin = ref1[2], destJsMult = ref1[3], destJsRjs = ref1[4];
    ...
    grunt.config.init({
      ...
      watch: {
        ...
        livereload: {
          ...
          files: ['./' + srcHtml + '/{,**/}*.html', './' + css2Min + '/{,**/}*.css', './' + css2Mult + '/{,**/}*.css', './' + js2Min + '/{,**/}*.js', './' + js2Mult + '/{,**/}*.js', './' + jsRequire + '/{,**/}*.js', './' + srcImg + '/{,**/}*.{png,jpg}', './' + srcFonts + '/{,**/}*']
        },
